...
class Sendemail extends \Magento\Framework\App\Action\Action
{
    ...
    public function SuccessEmail()
    {
        ...
        if($storeactivity == "1")
        {
            ...
            $transport = $this->_transportBuilder->setTemplateIdentifier    ('fastbazzar_success_template')
    ...
    public function FailEmail()
    {
        ...
        if($storeactivity == "1")
        {
            ...
            $transport = $this->_transportBuilder->setTemplateIdentifier    ('fastbazzar_fail_template')
            ->setTemplateOptions(['area' => 'frontend', 'store' => $store])
            ->setTemplateVars($templateVars)
            ->setFrom('sales')
            ->addTo($data['cus_email'])
    ...
    public function CancelEmail()
    {
        ...
        if($storeactivity == "1")
        {
            ...
            $transport = $this->_transportBuilder->setTemplateIdentifier    ('fastbazzar_cancel_template')
            ->setTemplateOptions(['area' => 'frontend', 'store' => $store])
            ->setTemplateVars($templateVars)
            ->setFrom('sales')
            ->addTo($data['cus_email'])
